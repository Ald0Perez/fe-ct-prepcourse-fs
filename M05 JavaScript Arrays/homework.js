...
function arrayContiene(array, elemento) {
   ...
   // Tu código:
   var existence = array.includes(elemento);
   if(existence){
      return true;
   }else{
      return false;
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   var palabra = num.toString().split('');
   if(palabra[0] == 9) return true;
   else return false;
}
...
function todosIguales(array) {
  ...
  return array.every(element => element === primerElemento);
}
...
function mesesDelAño(array) {
   ...
   if (meses.length === arrayNuevo.length) {
      return arrayNuevo;
   }else{
